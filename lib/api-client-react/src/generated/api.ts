...
export const getGetMetalPricesUrl = () => {
  return `/api/metal-prices`;
};

export const getMetalPrices = async (
  options?: RequestInit,
): Promise<MetalPrice[]> => {
  return customFetch<MetalPrice[]>(getGetMetalPricesUrl(), {
    ...options,
    method: "GET",
  });
};
...
export const getGetMetalPricesQueryKey = () => {
  return [`/api/metal-prices`] as const;
};
 ...
 */
export const getUpdateMetalPriceUrl = (id: number) => {
  return `/api/metal-prices/${id}`;
};

export const updateMetalPrice = async (
  id: number,
  updateMetalPriceRequest: UpdateMetalPriceRequest,
  options?: RequestInit,
): Promise<MetalPrice> => {
  return customFetch<MetalPrice>(getUpdateMetalPriceUrl(id), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateMetalPriceRequest),
  });
};

export const getUpdateMetalPriceMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateMetalPrice>>,
    TError,
    { id: number; data: BodyType<UpdateMetalPriceRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["updateMetalPrice"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateMetalPrice(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateMetalPriceMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateMetalPrice>>
>;
export type UpdateMetalPriceMutationBody = BodyType<UpdateMetalPriceRequest>;
export type UpdateMetalPriceMutationError = ErrorType<ErrorResponse>;
...
export const calculatePrice = async (
  ...
  return customFetch<CalculateResponse>(getCalculatePriceUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<CalculateRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type CalculatePriceMutationResult = NonNullable<
  Awaited<ReturnType<typeof calculatePrice>>
>;
export type CalculatePriceMutationBody = BodyType<CalculateRequest>;
